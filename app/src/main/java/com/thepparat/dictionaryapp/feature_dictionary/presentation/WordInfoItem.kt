package com.thepparat.dictionaryapp.feature_dictionary.presentation
...
fun WordInfoItem(
    ...
    Column(modifier = modifier) {
        ...
        wordInfo.sourceUrls.forEach {
            Text(text = it, color = Color.Blue, textDecoration = TextDecoration.Underline, modifier = Modifier.clickable {
                onclickWebView(it)
            })
        }
        Spacer(modifier = Modifier.height(16.dp))
